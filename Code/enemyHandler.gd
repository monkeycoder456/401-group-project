...
var ENEMY_RATIO = {"mummy": 1, "vampire": 5, "warewolf": 3, "zombie":10}
var ENEMY_FETCH = {"mummy":mummy_path,"vampire":vampire_path,"warewolf":warewolf_path,"zombie":zombie_path}
...
func _set_spawn_point_spawn_enemies(location : Vector2i, danger_value : int):
	...
	for unit in danger_value:
		...
		if enemy_array[0] is vampire or enemy_array[0] is warewolf:
